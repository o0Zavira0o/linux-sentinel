...
- Phase 5F: ACTIVE
- Milestone: 5F.6 — Ablation; generic execution preflight and deterministic-baseline common-scoring adapter are FROZEN. Corrective local context checkpoint `29573586877ebcbc475ed2f00172129089e60fdd` passed exact-SHA CI `32169631419` and pins manifest `e0da42efc5e67fc3d86b434a99e3e46dda257ba1a8b049c2adbb408e79582ee6` with context 49152 / max output 2048 / safety 1024. Clean blinded rebind `a2ddadf4fb93ad66589277122cdc40091f61ca488ba0f0be5f3f3de03f649ab2` prohibits `testzip()`, opens only RAW/MINIMAL/FULL member content, reproduces legacy 8192 falsification at 56/108, and yields 0/108 corrected capacity violations. Exact deterministic 324-attempt plan `0f9598d1ba9329b8de70339664c75982af3c3cac8111c29c46529204e8932542` / file `61b00ea75f7183f0bee6828b06d77125037cf308f073669906391729e4bbdf80` is frozen and bound into concrete-execution candidate `f87f7ff315b5a2d3cc310c8428a7822ac7ffd4c9a27a6ad408f4524f1fc790a3`. Concrete Execution Freeze and the Formal Mandatory Ablation Mapping Freeze are closed. Next: complete the documentation-only Formal Ablation Scoring Adapter Freeze transition for the CI-proven scorer-side adapter, then freeze exact external score-bearing ablation execution semantics before any benchmark score-bearing inference.
