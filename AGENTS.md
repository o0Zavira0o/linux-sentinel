...
- Active milestone: **5F.6 — Ablation; the private provider-neutral generic execution preflight and deterministic-baseline common-scoring adapter are FROZEN. Concrete Execution Freeze remains ACTIVE. The first local Ollama/Gemma execution-controls implementation checkpoint is CI-PROVEN at `991fe365300ed6a507d0e961fda48ed4bad8e566` / run `32155042040`, but its 8192-context capacity assumption was subsequently falsified pre-score by the frozen 108-request token map: 56/108 requests exceeded the 5120-token input budget, with maximum `CASE-0028:raw = 38091`. The preserved map identities are `token_counts.json` SHA-256 `a2ddadf4fb93ad66589277122cdc40091f61ca488ba0f0be5f3f3de03f649ab2`, evidence SHA-256 `113f0fd39256cafe80e86eaa41a3d82ac6fe9c7a3d09bb07fca33d03436cd5a2`, and receipt SHA-256 `b05995d1e8a849f71d80d90a6c7e7412237efb9dc664588cd1c12939bbad71fc`; no hidden stream or score-bearing generation was used. A corrective 49152-context f16 candidate was then validated live without corpus data: short-context resource proof was CONDITIONAL PASS at 79% GPU / zero swap, and a frozen 38087-token synthetic long-context request reproduced the tokenizer pre-count exactly (`38087 == 38087`), generated at 14.208 tok/s, used 79% GPU with peak 6735 MiB, and used zero swap. The repo correction from 8192 to 49152 is now the active pre-score implementation task; max output remains 2048, safety remains 1024, model/runtime/sampling identities remain unchanged, and normal score-bearing transport is still absent. The corrected manifest must pass Fedora gates, checkpoint/CI, 108-count rebind, and exact 324-attempt no-truncation planning before Concrete Execution Freeze can close. Mandatory ablations, deterministic corpus scores, and scored reasoner outputs remain absent.**
