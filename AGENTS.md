...
- Active milestone: **5F.6 — Ablation; the private provider-neutral generic execution preflight is FROZEN at implementation checkpoint `39d1db2845f6d461ab21a6da2077be2b77bf5982`, with formal docs-only freeze commit `291fa32cea930b78d933c3dd35e11260c98bab3f` and exact-SHA CI run `32108809270`. The pre-score deterministic-baseline common-scoring adapter has now passed authoritative Fedora validation: 12/12 dedicated tests, 27/27 frozen-scorer compatibility tests, 117/117 private Phase-5F tests, 1365/1365 full unit tests, 160-file format/lint scope, and strict mypy over 86 source files. It does not alter the frozen scorer, metrics, thresholds, baselines, corpus, or preregistration. Adapter checkpoint/CI freeze remains pending; concrete provider/model/tokenizer selection and all score-bearing requests remain blocked.**
