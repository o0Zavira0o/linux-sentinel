...
- Status: **5F.3 FROZEN — corpus-v1 capture/audit/freeze complete; 5F.4 FROZEN — Structured Reasoner Output boundary CI-proven; 5F.5 FROZEN — Primary Metrics scorer and formal freeze transition CI-proven; 5F.6 ACTIVE — generic execution preflight FROZEN; deterministic-baseline common-scoring adapter FROZEN; first local Ollama/Gemma execution-controls checkpoint `991fe365300ed6a507d0e961fda48ed4bad8e566` CI-PROVEN by run `32155042040`; its 8192-context capacity assumption FALSIFIED pre-score by the frozen 108-request token map (56/108 over budget, max 38091); corrective 49152-context f16 candidate LIVE-PROVEN on a 38087-token synthetic request with exact tokenizer/inference equality and zero swap; repo correction/revalidation, corrected-manifest 108-count rebind, exact 324-attempt plan, mandatory-ablation mappings, deterministic corpus scores, and scored reasoner outputs remain pending**
...
### 5F.6 — Ablation
Status: **ACTIVE — generic execution preflight and deterministic-baseline common-scoring adapter FROZEN; first local Ollama/Gemma execution-controls checkpoint CI-PROVEN; frozen 8192-context map validly falsified capacity; corrective 49152-context f16 candidate LIVE-PROVEN and now undergoing repo correction/revalidation; no score-bearing request exists**.
...
The deterministic adapter is formally frozen. A paid hosted-API candidate was abandoned before commit/provider request because a usable paid credential was unavailable; this is pre-score operational feasibility evidence, not a benchmark result. Concrete Execution Freeze uses the local Ollama/Gemma path. Live identity evidence pins Ollama `0.32.13`, model digest `be1d79d105352d8cb0a25ee03f1f315935cc93fb4f0674422c2bb13be72fc025`, and GGUF SHA `93567e57a8fe10b23569b9d9ec38cd005deedf71e29477c421a4b83f418a538b`. The service is loopback-only, cloud-disabled, single-parallel, and single-loaded-model; the private model-store boundary remains unchanged. The first execution-controls implementation checkpoint `991fe365300ed6a507d0e961fda48ed4bad8e566` passed Fedora validation and exact-SHA CI run `32155042040` with 18/18 dedicated tests, 34/34 execution+adapter tests, 135/135 private Phase-5F tests, and the full 1383/1383 gate. Its candidate manifest SHA was `a1e1e36a4176c6a6170cc7109ab481aabb2438c0ab70bb2b23fc30484dec96fa` and used context 8192 / max output 2048 / safety 1024. The first token-count attempt failed before any coordinate because the Phase-5F.6 evidence parent directory was absent; that zero-coordinate setup failure is preserved. Attempt 02 then completed all 108 non-score-bearing render/tokenizer counts, read only visible RAW/MINIMAL/FULL streams, and froze the map at `a2ddadf4fb93ad66589277122cdc40091f61ca488ba0f0be5f3f3de03f649ab2` with evidence SHA `113f0fd39256cafe80e86eaa41a3d82ac6fe9c7a3d09bb07fca33d03436cd5a2` and receipt SHA `b05995d1e8a849f71d80d90a6c7e7412237efb9dc664588cd1c12939bbad71fc`. The map validly falsified context 8192: 56/108 requests exceeded the 5120-token input budget (32 RAW, 24 FULL, 0 MINIMAL), with maximum `CASE-0028:raw = 38091`. No score-bearing request was sent. A corrective context of 49152 was selected pre-score, preserving max output 2048 and safety 1024 for a 46080-token input budget and 7989-token headroom over the observed maximum. Live f16 validation then showed a short synthetic CONDITIONAL PASS at 79% GPU and zero swap, followed by a frozen long-context calibration at 38087 tokens and an exact live inference equality `prompt_eval_count = 38087`; the long run passed with 14.208 generation tok/s, 79% GPU placement, peak 6735 MiB GPU memory, 24 GiB available RAM, and zero swap. The active code correction therefore changes only the context candidate from 8192 to 49152 and deterministically yields corrected manifest candidate SHA-256 `e0da42efc5e67fc3d86b434a99e3e46dda257ba1a8b049c2adbb408e79582ee6`. The corrected manifest remains unfrozen until Fedora validation/checkpoint/CI, 108-count rebind under the new manifest identity, and the exact 324-attempt generic no-truncation plan all pass. Future score-bearing payloads remain pure construction only; normal generation transport is still absent. Mandatory ablation mappings must also freeze before scored inference.
