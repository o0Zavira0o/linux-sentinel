...
Implement the frozen M1–M8 metric definitions and aggregation boundaries from `research/phase5f/METRICS.md` without changing thresholds, hidden-gold semantics, HARD/full analysis sets, or pseudoreplication rules. Scored B2/B3/B4 execution remains blocked until this scorer boundary is validated and frozen.
