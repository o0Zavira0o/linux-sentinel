...
Status: **ACTIVE — generic execution preflight and deterministic-baseline scoring adapter FROZEN; corrective local execution checkpoint `29573586877ebcbc475ed2f00172129089e60fdd` / CI `32169631419` CI-PROVEN; clean blinded 108-count map `a2ddadf4fb93ad66589277122cdc40091f61ca488ba0f0be5f3f3de03f649ab2` and exact 324-plan `0f9598d1ba9329b8de70339664c75982af3c3cac8111c29c46529204e8932542` FROZEN; binding candidate `f87f7ff315b5a2d3cc310c8428a7822ac7ffd4c9a27a6ad408f4524f1fc790a3` FROZEN; this docs-only checkpoint formalizes Concrete Execution Freeze only after green exact-SHA CI; no score-bearing output exists**. Concrete identity remains Ollama `0.32.13` / Gemma 4 12B IT QAT Q4_0 / GGUF `93567e57a8fe10b23569b9d9ec38cd005deedf71e29477c421a4b83f418a538b` / Ollama digest `be1d79d105352d8cb0a25ee03f1f315935cc93fb4f0674422c2bb13be72fc025`; context 49152, output 2048, safety 1024, max input 46080. Older `testzip()`-using token-count attempts remain preserved as history but are not blinding authority. Mandatory ablation mappings are the next pre-score gate.

The concrete provider/model manifest, clean blinded 108 measured semantic-request token counts, exact 324-attempt plan, and binding candidate are now evidence-frozen; this documentation-only checkpoint formalizes Concrete Execution Freeze only after green exact-SHA CI. Before the first benchmark score-bearing request, freeze the exact corpus-specific mechanical construction of every mandatory field-ablation view. Ablation identity belongs to execution/report metadata; do not reopen the frozen M1–M8 scorer merely to add ablation condition labels. The six preregistration files, thresholds, corpus-v1, frozen reasoner-output/scorer boundaries, FULL reference, and kill criteria remain unchanged.
