...
### 5F.6 — Ablation
Status: **ACTIVE — generic provider-neutral execution preflight FROZEN at `39d1db2845f6d461ab21a6da2077be2b77bf5982` with exact-SHA CI run `32108226447`; concrete manifest/capacity plan and mandatory-ablation mappings remain unfrozen pre-score work**.
