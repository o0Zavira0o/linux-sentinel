...
**5F.3B — Live Corpus Capture & Freeze: CURRENT after corrective 5F.3A freeze.** Restart the campaign from the beginning using the corrective frozen harness, require 8 Requires effect cases + 8 Wants bounded-negative cases, derive 20 adversarial cases, audit 36/16/20/28 counts and lineage/source-group invariants, archive/hash the result, and freeze corpus-v1 before 5F.4.
