...
- Phase 5F: ACTIVE
- Milestone: 5F.6 — Ablation; generic execution preflight and deterministic-baseline common-scoring adapter are FROZEN. The first local Ollama/Gemma execution-controls checkpoint `991fe365300ed6a507d0e961fda48ed4bad8e566` passed exact-SHA CI `32155042040`. Its 8192-context assumption was then falsified pre-score by the frozen 108-request token map (56/108 over budget; maximum 38091). Corrective 49152 + f16 passed live synthetic feasibility at the observed worst-case scale: calibrated 38087 tokens, exact tokenizer/inference equality, 14.208 generation tok/s, 79% GPU, peak 6735 MiB VRAM, zero swap. Next: validate and checkpoint the repo-only 8192→49152 correction, exact-SHA CI it, rebind all 108 token counts under the corrected manifest, and build the exact 324-attempt no-truncation plan before formal Concrete Execution Freeze or score-bearing inference
...
Status: **ACTIVE — generic execution preflight and deterministic-baseline scoring adapter FROZEN; first local execution-controls checkpoint CI-PROVEN; 8192 capacity FALSIFIED by the preserved 108-count map; corrective 49152-context f16 candidate LIVE-PROVEN and pending repo validation/checkpoint/CI; no score-bearing output exists**. Candidate identity remains Ollama `0.32.13` / Gemma 4 12B IT QAT Q4_0 / GGUF `93567e57a8fe10b23569b9d9ec38cd005deedf71e29477c421a4b83f418a538b` / Ollama digest `be1d79d105352d8cb0a25ee03f1f315935cc93fb4f0674422c2bb13be72fc025`. Corrective capacity is context 49152, max output 2048, safety 1024 (46080 input budget); the previous 8192 map remains frozen as falsification evidence and the corrected-manifest 108-count rebind is still required before the 324-attempt plan can freeze.
