...
### 5F.6 — Ablation
Status: **ACTIVE — Concrete Execution Freeze is closed; the seven-field mandatory ablation mapping preregistration is frozen at `5a4a7188742788954c2d7b1d11085057ab56594327c8306305286d9ba1b41844`; the private deletion-only implementation is CI-proven at `ea137456c97266c3c853a546e5af288b77008867` / CI `32228043568`; the 252-coordinate realization and corrected 252-request token-capacity audit are frozen with zero hidden/scoring/score-bearing activity and 0/252 capacity violations; this docs-only checkpoint is the formal Mandatory Ablation Mapping Freeze transition conditional on green exact-SHA CI; no benchmark score-bearing request or benchmark score exists**.
